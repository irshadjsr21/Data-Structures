...
/**
 * HashTable is a class to represent a hash table data structure 
...
class HashTable<T> {
  ...
  // Stores the current capacity of the table,i.e., how many elemets can the array store.
  ...
  public void displayStructure() {
    ...
    for(int i=0; i<this.arr.length; i++) {
      ...
      int len = 0;
      if(bucket != null) len = bucket.size();
